        ...
        C: Has<XSpanIdString>  + Send + Sync + 'static
    {
        ...
        match &method {
            ...
            &hyper::Method::GET if path.matched(paths::ID_QUESTIONS_ID_ANSWERS_) => {
                ...
                let param_id = match percent_encoding::percent_decode(path_params["id"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.questions_id_answers_get(
                                            param_id,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                QuestionsIdAnswersGetResponse::Ok
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            &hyper::Method::DELETE if path.matched(paths::ID_QUESTIONS_ID) => {
                ...
                let param_id = match percent_encoding::percent_decode(path_params["id"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.questions_id_delete(
                                            param_id,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
            ...
            &hyper::Method::GET if path.matched(paths::ID_QUESTIONS_ID) => {
                ...
                let param_id = match percent_encoding::percent_decode(path_params["id"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.questions_id_get(
                                            param_id,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
            ...
            &hyper::Method::GET if path.matched(paths::ID_QUESTIONS) => {
                                let result = api_impl.questions_get(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
...
impl<T> RequestParser<T> for ApiRequestParser {
    fn parse_operation_id(request: &Request<T>) -> Option<&'static str> {
        ...
        match request.method() {
            // QuestionsIdAnswersAnswerIdPut - PUT /questions/{id}/answers/{answerId}
            &hyper::Method::PUT if path.matched(paths::ID_QUESTIONS_ID_ANSWERS_ANSWERID) => Some("QuestionsIdAnswersAnswerIdPut"),
            // QuestionsIdAnswersGet - GET /questions/{id}/answers/
            &hyper::Method::GET if path.matched(paths::ID_QUESTIONS_ID_ANSWERS_) => Some("QuestionsIdAnswersGet"),
            // QuestionsIdAnswersPatch - PATCH /questions/{id}/answers/
            &hyper::Method::PATCH if path.matched(paths::ID_QUESTIONS_ID_ANSWERS_) => Some("QuestionsIdAnswersPatch"),
            // QuestionsIdAnswersPost - POST /questions/{id}/answers/
            &hyper::Method::POST if path.matched(paths::ID_QUESTIONS_ID_ANSWERS_) => Some("QuestionsIdAnswersPost"),
            // QuestionsIdDelete - DELETE /questions/{id}
            &hyper::Method::DELETE if path.matched(paths::ID_QUESTIONS_ID) => Some("QuestionsIdDelete"),
            // QuestionsIdGet - GET /questions/{id}
