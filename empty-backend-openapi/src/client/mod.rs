    ...
    C: Has<XSpanIdString> + Clone + Send + Sync + 'static,
{
    ...
    async fn questions_id_answers_answer_id_put(
        ...
        match response.status().as_u16() {
            200 => Ok(QuestionsIdAnswersAnswerIdPutResponse::Ok),
            code => {
    ...
    async fn questions_id_answers_get(
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(QuestionsIdAnswersGetResponse::Ok(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn questions_id_answers_patch(
        ...
        match response.status().as_u16() {
            200 => Ok(QuestionsIdAnswersPatchResponse::Ok),
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
                Err(ApiError(format!(
    ...
    async fn questions_id_answers_post(
        ...
        match response.status().as_u16() {
            200 => Ok(QuestionsIdAnswersPostResponse::Ok),
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
                Err(ApiError(format!(
    ...
    async fn questions_id_delete(
        ...
        match response.status().as_u16() {
            200 => Ok(QuestionsIdDeleteResponse::Ok),
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
                Err(ApiError(format!(
    ...
    async fn questions_id_get(
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(QuestionsIdGetResponse::Ok(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn questions_id_put(
        ...
        match response.status().as_u16() {
            200 => Ok(QuestionsIdPutResponse::Ok),
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
                Err(ApiError(format!(
    ...
    async fn questions_get(&self, context: &C) -> Result<QuestionsGetResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/v1/questions", self.base_path);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(QuestionsGetResponse::Ok(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn questions_post(
        ...
        match response.status().as_u16() {
            200 => Ok(QuestionsPostResponse::Ok),
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
                Err(ApiError(format!(
