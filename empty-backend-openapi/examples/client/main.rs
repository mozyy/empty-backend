...
fn main() {
    ...
    match matches.value_of("operation") {
        Some("QuestionsIdAnswersAnswerIdPut") => {
            let result = rt.block_on(client.questions_id_answers_answer_id_put(
                  56,
                  56,
                  None
            ));
        ...
        Some("QuestionsIdAnswersGet") => {
            let result = rt.block_on(client.questions_id_answers_get(
                  56
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("QuestionsIdAnswersPatch") => {
            let result = rt.block_on(client.questions_id_answers_patch(
                  56,
                  Some(&Vec::new())
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        ...
        Some("QuestionsIdAnswersPost") => {
            let result = rt.block_on(client.questions_id_answers_post(
                  56,
                  Some(&Vec::new())
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        ...
        Some("QuestionsIdDelete") => {
            let result = rt.block_on(client.questions_id_delete(
                  56
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("QuestionsIdGet") => {
            let result = rt.block_on(client.questions_id_get(
                  56
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("QuestionsIdPut") => {
            let result = rt.block_on(client.questions_id_put(
                  56,
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        ...
        Some("QuestionsPost") => {
            let result = rt.block_on(client.questions_post(
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
